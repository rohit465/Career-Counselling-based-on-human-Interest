...
<div style="margin-top:55px; left-margin:55px; background-color:rgb(217, 142, 137);">
    <a href="#!/web" style="font-size: 55px; align-text: center;" >web</a> <br>
	<a href="#!/programming" style="font-size: 55px;">programming</a> <br>
	<a href="#!/serverside" style="font-size: 55px;">server</a>
</div>
	<div ng-view></div>
	<script>
